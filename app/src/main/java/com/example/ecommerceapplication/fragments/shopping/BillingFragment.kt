...
import com.example.ecommerceapplication.data.order.Order
...
import com.example.ecommerceapplication.viewmodel.OrderViewModel
...
class BillingFragment: Fragment() {
    ...
    private fun showOrderConfirmationDialog() {
        val alertDialog = AlertDialog.Builder(requireContext()).apply {
            ...
            setMessage("Do you want to order the items from the cart?")
